...
export const ToAirportPins = (props) => {
  ...
  console.log('ToAirportPins', toAirports);
      ...
      <Marker key={`marker-${index}`} longitude={city.longitude} latitude={city.latitude}>
        <svg
          ...
          style={{
            ...
            fill: '#819DF1',
            stroke: 'none',
            transform: `translate(${-SIZE / 2}px,${-SIZE+5}px)`,
          }}
        ...
        {/* <IconContext.Provider value={{ color: '#819DF1', size: '24px' }}>
          <RiMapPin3Fill className={city.airportname} onClick={() => onClick(city)}></RiMapPin3Fill>
          <style jsx>{``}</style>
